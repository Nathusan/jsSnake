...
var snakeboard = document.getElementById("snakeboard"); // Return a two dimensional drawing context
...
function drawSnakePart(snakePart) {
  ...
  snakeboard_ctx.fillStyle = snake_col; // Set the border colour of the snake part

  snakeboard_ctx.strokestyle = snake_border; // Draw a "filled" rectangle to represent the snake part at the coordinates
  // the part is located

  snakeboard_ctx.fillRect(snakePart.x, snakePart.y, 10, 10); // Draw a border around the snake part
...
function snake_Controls(event) {
  ...
  var isGoingUp = dy === 10;
  var isGoingDown = dy === -10;
  var isGoingRight = dx === 10;
  var isGoingLeft = dx === -10;
...
function move_snake() {
  ...
  snake.unshift(head);
  var didEatFood = foodX == head.x && foodY == head.y;
